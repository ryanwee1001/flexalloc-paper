...
alloc_pages(1MB) calls could be made before failure. To reproduce our tests,
...
from alloc_pages(1MB) calls. Since each VM only needs 8 successful allocations,
we believe that the upperbound on the number of VM's due to potential alloc_pages(1MB)
